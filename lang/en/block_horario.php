...
$string['config_scheduling_mode_help'] = 'Set scheduling mode: allow access in the selected range time or deny access in the selected range time.';
...
$string['config_cohorts_help'] = 'Cohorts used to restrict or allow user access.';
